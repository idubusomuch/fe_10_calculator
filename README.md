...
- **버튼 active 효과**: 버튼을 마우스로 클릭하면 기존에 적용된 border의 너비를 줄여 버튼이 눌린 것 같은 시각적 피드백을 제공합니다.
- **특수 버튼 스타일링**: `AC`, `DEL` 등의 특수 버튼은 색상을 다르게 설정하여 주요 기능을 강조합니다.

## 동작 화면
![Image](https://github.com/user-attachments/assets/ff3ffce1-9953-4954-955b-cdef6edaa31c)
